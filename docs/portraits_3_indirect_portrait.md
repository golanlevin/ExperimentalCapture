...
What unites these projects is their use of procedural structures to transform traces into representations. By standardizing the kinds of evidence they collect, artists create frameworks for reasoning about identity through inference rather than direct observation. The resulting portraits emerge not through depiction, but through interpretation.
...
While a Creative Coding student at CMU, Shan Huang developed [Quantified Selfie: Browser History Visualization*](http://golancourses.net/2014/shan/03/06/project-3-shan-browser-history-visualization/) (2014), a self-portrait compiled from the favicons of the web sites she visited over a six-month period. Rather than depicting her appearance, Huang represents herself through accumulated patterns of attention. The resulting image is a portrait assembled from behavior recorded indirectly through digital traces.
...
In [*64000 Attempts at Circulation*](https://www.frieze.com/article/rose-salane-whitney-biennial-2022), the artist presents a collection of 64000 "slugs": arcade tokens and other fake coins that she acquired from a NYC Transit Authority auction. Each represents an instance — a *story* — of someone attempting to elude a fare on public transit. 

The tokens operate simultaneously as individual and collective portraits. Individually, they hint at the identity or circumstances of its owner; taken together, they form a portrait of thousands of anonymous acts of resistance, desperation, opportunism, and necessity.
...
David Maisel's [*Library of Dust*](https://davidmaisel.com/works/library-of-dust/) (2009) depicts approximately 3,500 individual copper canisters, each containing the cremated remains of patient from a state-run psychiatric hospital. The patients died at the hospital between 1883 and the 1970’s; their bodies have remained unclaimed by their families. Here the portrait has been reduced to a container and its contents, a totalizing reduction of a forgotten life.
...
Hasan Elahi conceived [*Tracking Transience*](https://www.ted.com/talks/hasan_elahi) (2002-), a self-tracking system that constantly and publicly presents his exact location, activities, and other personal data. Elahi documents the beds where he sleeps, the food he eats, the toilets he uses, and more. Instead of resisting surveillance, Elahi overwhelms it, producing an indirect self-portrait assembled entirely from traces of daily life. This self-surveillance project is a critique of contemporary investigative techniques and provides an ongoing “alibi” for Elahi in the event of future accusations.
...
[*Synecdoche*](https://puamsab.princeton.edu/2019/04/artist-feature-byron-kim-isabel-griffith-gorgati-21/) (1991-) is a collection of panels representing the skin color of hundreds of individuals who have sat for Byron Kim. It is housed in the National Gallery of Art in Washington, DC. Each panel functions as a *synecdoche*: a small sample of skin standing in for an entire person. (Compare with [*Humanae*](images/typologies/angelica_dass_humanae.jpg) by Angelica Dass)
...
* Rafael Lozano-Hemmer, [*Pulse Room*](https://www.lozano-hemmer.com/pulse_room.php) (2006). 
* Jill Magid, [*Evidence Locker*](http://www.jillmagid.com/projects/evidence-locker-2) (2004).
* Angelica Dass, [*Humanae*](images/typologies/angelica_dass_humanae.jpg) (2020).
* Song Dong, [*Waste Not*](https://smarthistory.org/song-dong-waste-not/) (2005).
* Felix Gonzalez-Torres, [*Untitled (Portrait of Ross in L.A.)*](https://www.youtube.com/watch?v=37bSb-aQ4BM) (1991).
