...
In these rule-based approaches to comparative portraiture, artists devise systematized workflows, behavioral frameworks, and procedural situations for eliciting **candid** views of their subjects. They rely not on computation, but on the observational logic of [cinéma vérité](https://en.wikipedia.org/wiki/Cin%C3%A9ma_v%C3%A9rit%C3%A9) and the organizational logic of the [small multiple](https://en.wikipedia.org/wiki/Small_multiple). Rather than seeking authenticity through spontaneity alone, the artists engineer repeatable circumstances in which subtle differences in behavior, attention, stress, labor, vulnerability, or personality can emerge.

Across these projects, the "portrait machine" is not the camera but the *designed situation* surrounding it. The artist constructs a constrained social, physiological, or psychological apparatus, then steps back and allows the system to generate a series of involuntary and revealing human responses. The usual context of a portrait sitting is replaced by a repeated test, ritual, provocation, endurance task, or behavioral trap. Personality emerges not through the subject's pose but through their reaction.
...
[![*Ten Meter Tower*](images/portraits/portrait_dive.gif)](https://www.youtube.com/watch?v=5QMlIjSnt_E)
...
In [*Time is Money*](https://www.yurenev.com/projects/time-is-money) (2022-2025), Alexey Yurenev traveled across New York City and asked people of different professions how long it takes them to earn one dollar. He then used their responses to set the exposure time for their respective portraits while they worked.
...
McDonald wrote a simple application that automatically took one picture every minute. If it found a face, it uploaded the photo to his server. He installed the app in Apple stores around NYC over three days, collecting more than a thousand photos.
...
In the [*Hysterical Literature*](http://hystericalliterature.com/sessions) video series, participants attempt to read literary texts aloud while subjected to escalating off-camera physical distraction, producing involuntary interruptions and revealing tensions between composure, intellect, and control. Like many of the examples here, the work derives its power from a deliberately engineered situation that produces involuntary human responses.
...
### Eva Teppe's Visualization for Elliott Carter
...
![Sitting with Marina](images/portraits/artist_is_present_sitting_with_marina.jpg)

In her 3-month performance project at MoMA, [*The Artist is Present*](https://www.youtube.com/watch?v=taKQwPTtRjg) (2010), Marina Abramovic sat silently across a table from visitors. Participants could remain for as long as they wished, engaging only in sustained eye contact. Deprived of conversation, distraction, and social scripts, many subjects exhibited unexpectedly intense emotional responses, ranging from discomfort and nervousness to tears. [The accompanying series of portraits](https://www.flickr.com/photos/themuseumofmodernart/albums/72157623741486824/) are records of people subjected to the same simple condition: prolonged mutual gaze.

![Sitting with Marina](images/portraits/abramovic_present.jpg)
...
* Andy Warhol, [*Screen Tests*](portraits_1_series.md#screen-tests) (1964–66). Subjects sit silently for several minutes in front of a stationary film camera. Their microexpressions become monumental.
* Gillian Wearing, [*Signs that say what you want them to say*](https://www.tate.org.uk/art/artworks/wearing-signs-that-say-what-you-want-them-to-say-and-not-signs-that-say-what-someone-else-66092) (1992). Participants hold handwritten confessions in public space.
* Harun Farocki, [*Serious Games*](https://vimeo.com/370494311). Recordings of soldiers engaging in battle simulations.
* Erwin Wurm, [*One Minute Sculptures*](https://publicdelivery.org/erwin-wurm-one-minute-sculptures/). A collection of photos documenting absurd participatory temporary performance-sculptures.