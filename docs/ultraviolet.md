...
![uv_sunscreenr.jpg](images/multispectral/uv_sunscreenr.jpg)<br />*[Inexpensive UV cameras](https://www.amazon.com/Soufyuane-Portable-Effective-Protection-Detection/dp/B0DVSZG81V/) are now widely available for examining sunscreen.*

Ultraviolet light has wavelengths that range from around 10nm-400nm. The "black light" that we know from clubs is "near-UV" or UVA (315–400 nm), and is responsible for tanning, photoaging, and some skin damage. UVB (280–315 nm) causes most sunburn and contributes strongly to skin cancer. UVC (100–280 nm) is almost entirely absorbed by the atmosphere, but artificial UVC sources can rapidly damage skin and eyes. The shortwave "Vacuum UV" band closest to X-rays is strongly absorbed by air. In this course we will only be working with UVA imaging.

![uv_light_spectrum.jpg](images/uv/uv_light_spectrum.jpg)
...
| UV **reflectance** (UVR)           | UVA reflections     | UVA          |
| UV **fluorescence** (UVF or UVIVF) | visible emissions   | UVA          |

### 10-minute quick lesson:

* Watch [Veritasium video](https://www.youtube.com/watch?v=V9K6gjR07Po), 0-2m
* Watch [BBC kestrel video](https://www.youtube.com/watch?v=V9K6gjR07Po), 0-1m
* UVR in [insect vision](images/uv/uv_golden-groundsel.jpg), [forensics](images/uv/uv_forensics_paint.jpg) and [conservation](images/uv/uv_restoration.jpg)
* UVR portraiture by [Cara Phillips](https://cara-phillips.com/ultraviolet-beauties)
* Difference between UVR and UVF imaging
* UVF imaging of [minerals](uv_fluorescent_minerals.jpg), [forensics](images/uv/fluorescence_csm_body_fluid.jpg), and [security](images/multispectral/canadian-passport-with-uv.jpg)
* UVF photography by [Mikael Owunna](https://www.mikaelowunna.com/)
* UV sunscreen camera demo
...
* [*The World In UV*](https://www.youtube.com/watch?v=V9K6gjR07Po), an excellent 11m overview video by science YouTuber @Veritasium, discusses how UV offers new understandings of atmospheric haze, sunscreen, quinine, flowers, polar bears, and more:<br />[![The world in UV](images/uv/the_world_in_uv.png)](https://www.youtube.com/watch?v=V9K6gjR07Po)
* YouTuber [Physics Girl](https://www.youtube.com/watch?v=GRD-xvlhGMc) discusses sunscreen specifically in [this 12-minute PBS video](https://www.youtube.com/watch?v=GRD-xvlhGMc).<br />[![uv_physics_girl_sunscreen.jpg](images/multispectral/uv_physics_girl_sunscreen.jpg)](https://www.youtube.com/watch?v=GRD-xvlhGMc)
* [UV video overview by Thomas Leveritt](https://www.youtube.com/watch?v=o9BqrSAHbTc), showing diverse faces with/without sunscreen:<br />[![Thomas Leveritt video](images/uv/uv_leveritt.png)](https://www.youtube.com/watch?v=o9BqrSAHbTc)
...
[Kestrels can see in the UV](https://youtu.be/AUm-TabNFF0), which helps them find prey from their UV-fluorescent urine. Here's David Attenborough (2m video): <br />[![kestrel-vision.png](images/uv/uv-kestrel-vision.png)](https://youtu.be/AUm-TabNFF0)
...
Many flowers have [petals that appear plain to humans, but UV coloring](https://www.wildflower.org/magazine/native-plants/a-different-light) that gives them a bull's eye-like design that attracts bees and enhances contrast for their vision:<br />![uv_snow-on-the-prairie.jpg](images/uv/uv_snow-on-the-prairie.jpg)

Here's an article on [birds & bees' UV vision](http://www.nature.com/scitable/blog/the-artful-brain/alternate_realities), featuring this false-color image which shows the additional information in eggs and plumage:<br />![Bird vision makes use of UV](images/uv/uv_birds.png)

UV is also [widely used in forensics](http://ultravioletcameras.com/applications/longwave-ultraviolet-forensics-imaging-applications/), showing evidence of repair and cleaning:<br />![Cleaning marks visualized with UV](images/uv/uv_forensics_paint.jpg)
...
Cara Phillips makes portraits that explore the [aesthetics of the human skin in UV](https://cara-phillips.com/ultraviolet-beauties):<br />![Portrait by Cara Phillips](images/uv/uv_cara_phillips.jpg)
...
![uv_restoration.jpg](images/uv/uv_restoration.jpg)
...
* Of course, [dedicated UV cameras](http://www.edmundoptics.com/cameras/nir-uv-cameras/sony-xc-e-series-monochrome-ccd-cameras/56346/) also exist, some of which, like this [sunscreen UV camera attachment](https://www.amazon.com/Soufyuane-Portable-Effective-Protection-Detection/dp/B0DVSZG81V/) for mobile phones, are relatively inexpensive.


![Golan in UV](images/uv/uv_golan.jpg)<br />*The STUDIO has a small selection of UV cameras. You can see some of my skin damage.*
...
![fluorescence_black_light_theatre.jpg](images/multispectral/fluorescence_black_light_theatre.jpg)
...
![fluorescence_mikael_owunna.jpg](images/multispectral/fluorescence_mikael_owunna.jpg)
...
There's lots of interesting UV fluorescence in nature, such as in these minerals:<br />![Rocks fluorescing](images/uv/fluorescent_minerals.jpg)

Scorpions fluoresce under ultraviolet light, but scientists do not know why.<br />![Scorpions glow in UV](images/uv/uv_scorpion.jpg)

Because the material is *absorbing* UV light, most fluorescent materials appear dark in a UV camera. Here, fluorescence from a hilighter pen (at right) is viewed by one of the STUDIO's UV cameras (at left):<br />![fluorescence-test.jpg](images/uv/fluorescence-test.jpg)
...
*UV fluorescence reveals hidden imagery in a Canadian Passport and Danish currency:*<br />![canadian-passport-with-uv.jpg](images/multispectral/canadian-passport-with-uv.jpg)
...
![Forensic detection of body fluids](images/uv/fluorescence_csm_body_fluid.jpg)
...
![uv_395_vs_365.jpg](images/uv/uv_395_vs_365.jpg)
